...
class MenuView extends GetView<CustomMenuController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CustomMenuController>(builder: (controller) => Scaffold(
      ...
      body: Stack(
        children: [
          IndexedStack(
            ...
            children: [
              Container(child: Center(child:ListView.builder(itemBuilder: (context, index) => Center(child: Text(index.toString())),))),
                      ...
                      .map(
                        ...
                        Container(
                          decoration: BoxDecoration(
                              ...
                              color: controller.currentIndex.value==item.index?CustomColors.primary:null
                          ),
                          child: IconButton(onPressed: () {
                            controller.changeScreen(item.index);
                          }, icon: Icon(item.icon,color: controller.currentIndex.value==item.index?CustomColors.background:null,),
